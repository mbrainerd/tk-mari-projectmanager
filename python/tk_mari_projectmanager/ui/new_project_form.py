...
class Ui_NewProjectForm(object):
    def setupUi(self, NewProjectForm):
        ...
        self.context_warning_label.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
...
"}")
    ...
    def retranslateUi(self, NewProjectForm):
        ...
        self.context_widget.ui.label.setText(QtGui.QApplication.translate("NewProjectForm", "Select the Task for the new Project:", None, QtGui.QApplication.UnicodeUTF8))
        self.project_groupbox.setTitle(QtGui.QApplication.translate("NewProjectForm", "Project Settings:", None, QtGui.QApplication.UnicodeUTF8))
